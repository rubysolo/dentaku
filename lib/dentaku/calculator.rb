...
module Dentaku
  class Calculator
    ...
    def add_function(name, type, body, execute = nil)
      @function_registry.register(name, type, body, execute)
      self
    end

    def add_functions(fns)
      fns.each { |(name, type, body, execute)| add_function(name, type, body, execute) }
      self
    end
